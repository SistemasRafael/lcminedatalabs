...
if ($resultado->num_rows > 0) {
    ...
    $supervisor3 = 'francisca.orduno@heliostarmetals.com';
    $supervisor4 = 'claudia.delgado@heliostarmetals.com';
    $laboratorio = 'rafael.arvizu@heliostarmetals.com'; 
    $copy = 'danira.romero@heliostarmetals.com';           
    $geo1 = 'jesus.moreno@heliostarmetals.com';
    $geo2 = 'jesus.grijalva@heliostarmetals.com';
    $geo3 = 'manuel.labandera@heliostarmetals.com';    
    $geo4 = 'elizandell.delavara@heliostarmetals.com';
                    ...
                    try {
                        ...
                        $mail->Username   = 'bitacora.arg@heliostarmetals.com';                     //SMTP username
                        $mail->Password   = 'Axioma$3112$';                               //SMTP password
                        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
                        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
                        $mail->setFrom('bitacora.arg@heliostarmetals.com', 'Argonaut Gold');
