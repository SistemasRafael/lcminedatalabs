...
$preeli      = $_POST['preel'];
/*
$trn_id      = $_GET['trn_id_l'];
$metodo_id_l = $_GET['metodo_id_l'];
$preeli      = $_GET['preel'];*/
    ...
    if ($preeli == 1){
       ...
       if ($resultado->num_rows > 0) {
           ...
           // $datos_in = $resultado ->fetch_array(MYSQLI_ASSOC);
            ...
            //$html = 'Se inici� su orden de trabajo con folio de seguimiento '.$folio_interno;
           // $supervisor1 = 'samuel.ortega@argonautgold.com';
            $supervisor2 = 'claudia.delgado@floridacanyon.com';
            $supervisor3 = 'francisca.orduno@floridacanyon.com';
            $supervisor4 = 'rafael.arvizu@floridacanyon.com';

            $geo1 = 'jesus.moreno@floridacanyon.com';
          //  $geo2 = 'gerardo.portales@argonautgold.com';
            $geo2 = 'jesus.grijalva@floridacanyon.com';
            $geo3 = 'manuel.labandera@floridacanyon.com';
            $geo4 = 'mayra.gutierrez@floridacanyon.com';            
            $geo5 = 'arturo.navarro@floridacanyon.com';

            $copy = 'danira.romero@floridacanyon.com';
            
	                $_subject = "Liberaci&oacuten de Batch de Trabajo: ".$folio;
                    $_recipient = $cliente;//$empleado_email;	
                    
                    $_body = "Se ha liberado el batch de trabajo con folio <strong>".$folio."</strong> para el m&eacutetodo <strong>".$metodo."</strong> solicitada la fecha <strong>".$fecha."</strong><br><br>";
                    ...
                    try {
                        ...
                        $mail->Host       = 'outlook.office365.com';//'smtp.office365.com';                     //Set the SMTP server to send through
                      ...
                      //  $mail->addAddress($supervisor1); 
                        ...
                        $mail->Body   = $body;
                        $mail->send();
                        echo 'Se envi� correctamente el mensaje';
                    } catch (Exception $e) {
