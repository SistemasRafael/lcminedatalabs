...
if ($resultado->num_rows > 0) {
    ...
    $supervisor1 = 'elizandell.delavara@heliostarmetals.com';
    $supervisor2 = 'francisca.orduno@heliostarmetals.com';
    $supervisor3 = 'claudia.delgado@heliostarmetals.com';
    $laboratorio = 'rafael.arvizu@heliostarmetals.com';
    $copy = 'danira.romero@heliostarmetals.com';
    $geo1 = 'jesus.moreno@heliostarmetals.com';
    $geo2 = 'erasmo.valenzuela@heliostarmetals.com';
   // $geo3 = 'manuel.labandera@heliostarmetals.com'; 
                    ...
                    try {
                        ...
                        $mail->Username   = 'bitacora.hstr@heliostarmetals.com';                     //SMTP username
                        $mail->Password   = 'B1t4c0r4.h$tr';//'Axioma$3112$';                               //SMTP password
                        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
                        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
                        $mail->setFrom('bitacora.hstr@heliostarmetals.com', 'HSTR');
