...
$pdf_style .= '@page { margin-top: 240px; margin-bottom: 100px; margin-left: 0px; margin-right: 0px; }';
...
$pdf_style .= '#footer { position: fixed; left: 15px; bottom: -120px; right: 0px; height: 110px; }';
$pdf_style .= '#footer.page:after { content: counter(page, upper-roman); }';
$pdf_style .= '';

            $trn_id = $_GET['trn_id'];            
            $datos_orden = $mysqli->query("SELECT
                                                un.nombre AS unidad, ord.folio, ord.fecha, ord.hora, us.nombre AS usuario, ord.tipo
            ...
            if ($orden_encabezado['tipo'] == 2){
                                            $datos_orden_encab = $mysqli->query("SELECT DISTINCT ms.folio,
                                                	    od.trn_id, od.trn_id_rel, od.folio_interno
                                                  ...
                                                  WHERE od.trn_id_rel = ".$trn_id)or die(mysqli_error($mysqli));
                                        }else{
            ...
            $datos_metodos = $mysqli->query("SELECT 
             ...
             $datos_muestras_tipo = $mysqli->query("SELECT
                                                  ...
                                                  WHERE od.trn_id_rel = ".$trn_id."
                                                  ORDER BY
                                                	os.folio_interno")or die(mysqli_error($mysqli));
                 ...
                 <table border='2' width='98%' CELLPADDING=5 CELLSPACING=0 style='font-size:9px;'>
                             <thead>
                                 <tr border>   
                                    ...
                                    <th width='20%' align='left'>Turno: </th> 
                                    <th width='30%' align='left'>Orden de Trabajo: </th>
                                  </tr>                                  
                                  <tr>            
                                    <th width='30%' align='left'><strong>".$orden_encabezado['fecha']."</strong></th>
                  ...
                  $html_en .= "<table border='2' width='98%' CELLPADDING=5 CELLSPACING=0 style='font-size:9px;'>
                             <thead>
                                 <tr border>   
                                    ...
                                    <th width='30%' align='left'>Tipo de Muestra:</th>
                                  </tr>                                  
                                  <tr>            
                                    <th width='30%' align='left'><strong>".$orden_encabezado['usuario']."</strong></th>
                                    <th width='20%' align='left'>".$datos_muestras_area."</th>
                                    <th width='30%' align='left'>Soluciones</th>                                  
                                  </tr>";
                  $html_en  .="</thead></table>";
                  $html_det .= "<br/<div style='position:relative; margin: 15px; margin-top: 15px; font-size: 12px;'>";
             }
             else{
                 $html_en = "<br/>
                 <table border='2' width='98%' CELLPADDING=5 CELLSPACING=0 style='font-size:9px;'>
                  ...
                  $html_det .= "<table  border='1' width='100%' CELLPADDING=5 CELLSPACING=0>
                                <thead>                                
                                     <tr>    
                                    ...
                                    <tr>   
                                        ";  
                                        if ($orden_encabezado['tipo'] == 2){
                                            $html_det .= "<th colspan='1'>No</th>";
                                            $html_det .= "<th colspan='3'>Batch</th>";
                                            $html_det .= "<th colspan='3'>Muestras</th>";
                                            $html_det .= "<th colspan='1'>Cantidad</th>";
                                        }else{
                                            $html_det .= "<th colspan='3'>Batch</th>";
                                            $html_det .= "<th colspan='2'>De la muestra</th>
                               ...
                               while ($fila = $datos_orden_encab->fetch_assoc()) {
                                   ...
                                   $html_det.="<tr>";
                                      ...
                                      if ($orden_encabezado['tipo'] == 2){                                     
                                        $html_det.="<td colspan='1' align='right'>".$renglon."</td>";
                                        $renglon++;
                                      }
                                      $html_det.="<td colspan='3'>".$fila['folio_interno']."</td>";
                                      if ($orden_encabezado['tipo'] == 2){
                                         
                                         $html_det.="<td colspan='3'>".$fila['folio']."</td>";
                                         $html_det.="<td colspan='1' align='right'>1</td>";
                                      }
                                      else{
