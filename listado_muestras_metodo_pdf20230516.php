...
$pdf_style .= '#header { position: fixed; left: 5px; top: -25px; right: 0px; height: 190px; text-align: center;font-size: 75% }';
$pdf_style .= '#body { position: left; height: 250px; text-align: left; left: 5px; font-size: 40% }';
                                            ...
                                            <thead>                                
                                                <tr>      
                                                    ...
                                                    if ($tipo_orden == 2) { 
                                                        ...
                                                        $html_det .= "<th align='center' colspan='2'>CNa</th>";
