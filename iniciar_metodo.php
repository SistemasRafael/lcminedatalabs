...
if (isset($trn_id)){    
   ...
   $orden_trabajo = $tipo_ord['folio_interno'];
    ...
    if ($resultado->num_rows > 0) {
       ...
       //Inicia metodo EFAAG-30 con pesaje de la fase 9 Etapa 5 pesaje
        if($fase_id == 9 && $etapa_id == 5){
        while ($res = $resultado->fetch_assoc()) {            
                  $tipo_can          = $res['cantidad_tipo'];
                  $cantidad_muestras = $res['cantidad_muestras']; 
                  $total             = $res['total'];
       ...
       }//Fin etapa 5 pesaje muestras de la fase 9 METODO EFAAG-30
       
       //Inicia Incuarte del m�todo EFAAG-30
        ...
        while ($res = $resultado->fetch_assoc()) {            
                 ...
                 if ($existen_peso->num_rows > 0) {
                        ...
                        while ($res_muestras = $peso_det->fetch_assoc()) {
                            ...
                            $muestra_folio = $res_muestras['muestra'];
                            $muestra_control = $res_muestras['control'];
                            $peso_actual   = $res_muestras['incuarte'];
                            $html.="<tr>                                  
                                         <td>".$con."</td> 
                                         <td style='display:none;'> <input type='input' id='trnid_batch_met".$con."' value='".$trnid_batch."'/></td>  
                                         <td style='display:none;'> <input type='input' id='trnid_rel_met".$con."' value='".$trnid_rel."'/>".$muestra_folio."</td>                           
                                         <td>".$muestra_folio."</td>
                                         <td>".$muestra_control."</td>
                                         <td> <input type='number' id='incuarte_met".$con."' value='".$peso_actual."' class='form-control'/> </td>
       ...
       }//Fin etapa 5 pesaje muestras de la fase 9 METODO EFGRAV30
       ...
       //if($fase_id == 2 && $etapa_id == 8){
                 ...
                 if ($existen_peso_pay->num_rows > 0) {
                        ...
                        while ($res_muestras_pay = $existen_peso_pay->fetch_assoc()) {
                            ...
                            $html.="<tr>                                  
                                         ...
                                         <td> <button type='button'class='btn btn-primary' id='boton_save_pay' onclick='met_payon_guardar(".$trnid_batch.",".$trnid_rel.",".$metodo_id.",".$fase_id.",".$etapa_id.",".$con.",".$unidad_id.")' >
                                                    <span class='fa fa-cloud fa-1x'></span>
                                              </button>
                                         </td>
                                    </tr>";
        ...
        while ($res = $resultado->fetch_assoc()) {
                  ...
                  $con = 0;
                  if ($reensaye == 0){
                        $existen_peso_dore = $mysqli->query("SELECT
                                                	         ot.trn_id_batch,
                                                             ot.trn_id_rel,
                                                             pul.peso_dore AS peso_dore,
                                                             ot.folio_interno as muestra,
                                                             ot.control
                                                           FROM 
                                                           arg_muestras_resultados pul
                 ...
                 if ($existen_peso_dore->num_rows > 0) {                                         
                        while ($res_muestras_dore = $existen_peso_dore->fetch_assoc()) {
                            $con           = $con+1;    
                            $trnid_batch   = $res_muestras_dore['trn_id_batch'];
                            $trnid_rel     = $res_muestras_dore['trn_id_rel'];
                            $muestra_folio = $res_muestras_dore['muestra'];
                            $control       = $res_muestras_dore['control'];
                            $peso_actual   = $res_muestras_dore['peso_dore'];
                            $html.="<tr>                                  
                                         <td>".$con."</td> 
                                         <td style='display:none;'> <input type='input' id='trnid_batch_dore".$con."' value='".$trnid_batch."'/></td>  
                                         <td style='display:none;'> <input type='input' id='trnid_rel_dore".$con."' value='".$trnid_rel."'/>".$muestra_folio."</td>                             
                                         <td>".$muestra_folio."</td>                                         
                                         <td> <input type='number' id='peso_dore".$con."' value='' class='form-control'/> </td>
                                         <td> <button type='button'class='btn btn-primary' id='boton_save_dore' onclick='met_dore_guardar(".$trnid_batch.",".$trnid_rel.",".$metodo_id.",".$fase_id.",".$etapa_id.",".$con.",".$unidad_id.")' >
                                                    <span class='fa fa-cloud fa-1x'></span>
                                              </button>
                                         </td>
                                    </tr>";
       ...
       if($etapa_id == 22){
           while ($res = $resultado->fetch_assoc()) {
            ...
            $html =  "<table class='table text-black' id='datos_Ataque'>
                            <thead class='thead-info' align='left'>
                                <tr class='table-info'>
                                        <th colspan='3'>".$metodo."</th>
                                </tr>
                            ...
                            <tr>";                             
                                $html.="                                                           
                                    ...
                                    <td> <button type='button'class='btn btn-primary' id='boton_save_fun' onclick='ataque_guardar(".$trn_id.", ".$metodo_id.")' >
                                             <span class='fa fa-cloud fa-1x'></span>
                                         </button>
                                    </td>
                            </tr>";
       ...
       if($fase_id == 6 && $etapa_id == 4){
        ...
        if($etapa_id == 23 || $etapa_id == 24 || $etapa_id == 25){      
            while ($res = $resultado->fetch_assoc()) {   
                  $metodo            = $res['metodo'];
                  $fase              = $res['fase'];
                  $etapa             = $res['etapa'];
                 ...
                 if ($existen_titulacion->num_rows > 0) {                                         
                        $titulacion_det = $mysqli->query("SELECT 
                                                             os.trn_id_batch
                                                            ,os.trn_id_rel   
                                                            ,ms.folio AS muestra
                                                            ,os.resultado                                                       
                                                          ...
                                                          ORDER BY os.folio_interno") or die(mysqli_error());
