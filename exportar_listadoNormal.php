...
$objSheet->setCellValue('J2', 'Au_ppm'); //->setValue('Codigo Metodo');
$objSheet->setCellValue('K2', 'Ag_ppm'); //->setValue('Codigo Metodo');
$objSheet->setCellValue('L2', 'Reensaye'); //->setValue('Nombre Metodo');
...
while ($row = $result->fetch_row()) {
 // if ($row[4] == $metodo) {
    ...
    $objSheet->setCellValue('I' . $i, $row[12]);
    $objSheet->setCellValue('J' . $i, $row[9]);
    $objSheet->setCellValue('K' . $i, $row[10]);
    $objSheet->setCellValue('L' . $i, $row[13]);
    $num = $num + 1;
    $i = $i + 1;
  //}
