...
$check_query1 = $mysqli->query("SELECT d.folio FROM arg_ordenes_detallePlantas d INNER JOIN arg_ordenes_plantas o ON d.trn_id_rel = o.folio
 WHERE o.usuario_id = $u_id AND o.fecha = '$fecha' AND d.circuito_id = $circuito AND d.estado_id = 0") or die(mysqli_error($mysqli));
