...
$check_select_query = $mysqli->query("SELECT DISTINCT o.folio, d.circuito_id, d.estado_id FROM arg_ordenes_plantas o INNER JOIN arg_ordenes_detallePlantas d ON o.folio = d.trn_id_rel WHERE (o.fecha = '$fecha_hora') AND o.usuario_id = $u_id ORDER BY d.circuito_id");
$return = [];
