       ...
       if ($resultado->num_rows > 0) {
           ...
           // $datos_in = $resultado ->fetch_array(MYSQLI_ASSOC);
            ...
            $copy = 'danira.romero@argonautgold.com';
	                ...
	                $_subject = "Liberaci�n de Batch de Trabajo: ".$folio;
                    $_recipient = $cliente;//$empleado_email;	
                    
                    $_body = "Se ha liberado el batch de trabajo con folio <strong>".$folio."</strong> para el m�todo <strong>".$metodo."</strong> solicitada la fecha <strong>".$fecha."</strong><br><br>";
