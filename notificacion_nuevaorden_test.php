...
if (isset($trn_id)){
   ...
   $resultado = $mysqli->query("SELECT o.trn_id, o.folio as orden, o.fecha, 
                                        ...
                                        , u.codigo as usuario, 'danira.romero@heliostarmetals.com'  AS email
                                    FROM arg_ordenes o
...
if ($resultado->num_rows > 0) {
    ...
    $supervisor4 = 'claudia.delgado@floridacanyon.com';
    $laboratorio = 'rafael.arvizu@floridacanyon.com'; */
    $copy = 'danira.romero@heliostarmetals.com';           
    ...
    $geo4 = 'mayra.gutierrez@floridacanyon.com';*/
                    ...
                    $_recipient = $copy;//$empleado_email;//$empleado_email;	
                    ...
                    try {
                        ...
                        $mail->Host       = 'smtp.office365.com';//'smtp.office365.com';                     //Set the SMTP server to send through
                        $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
                        $mail->Username   = 'bitacora.Hstr@heliostarmetals.com'; // 'bitacora.arg@argonautgold.com';                     //SMTP username
                        $mail->Password   = 'F*445493090263uj'; //'Axioma$3112$';                               //SMTP password
                        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
                        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
                        $mail->setFrom('bitacora.Hstr@heliostarmetals.com', 'Argonaut Gold');
