...
$pdf_style .= '@page { margin-top: 40px; margin-bottom: 90px; margin-left: 20px; margin-right: 10px; }';
$pdf_style .= 'html, body, table { font-family: helvetica; font-size: 100%; }';
$pdf_style .= '#header { position: fixed; left: 15px; top: -25px; right: 10px; height: 190px; text-align: center;font-size: 75% }';
$pdf_style .= '#body { position: left; height: 250px; text-align: left; right: 10px; left: 5px; font-size: 40% }';
...
$pdf_style .= '.column { float: left; width: 55.33%; top: 33.33%; text-align: left; font-size: 80%}';
...
$datos_orden = $mysqli->query("SELECT
                                ...
                                ,(CASE ord.tipo WHEN 0 THEN 0 WHEN 1 THEN 1 WHEN 2 THEN 2 
                                                WHEN 5 THEN 5 WHEN 6 THEN 6 WHEN 7 THEN 7 ELSE 0 
                                  END) AS tipo                                
...
if ($tipo_orden == 1 or $tipo_orden == 6) {
    $detalle_etiquetas = $mysqli->query("SELECT
        ...
        $detalle_etiquetas = $mysqli->query("SELECT                                                
                                                ...
                                                ,1  AS posicion                                                
                                            FROM
                                                arg_ordenes_muestrasRecheck od
                                            WHERE
                                                od.trn_id_rel = " . $trn_id . "
                                            ORDER BY od.folio") or die(mysqli_error($mysqli));
    } */
        ...
        // echo 'okkkkk';
         $detalle_etiquetas = $mysqli->query("SELECT                                                
                                                 ...
                                                 ,1 AS posicion                                            
                                             FROM
                                                 ordenes_reensayes_metal  AS od 
                                                 WHERE od.trn_id_rel = " . $trn_id . "
                                                 AND od.metodo_id = " . $metodo_id . " 
                                             ORDER BY od.posicion") or die(mysqli_error($mysqli));
     }
    else{
...
$html_en = "";
//"<h1>".$folio."</h1>.</br></br></br></br></br></br>
$html_en .= "</br></br></br></br></br></br></br></br></br></br>
            <table border='0' width='100%' CELLPADDING=3 CELLSPACING=0>
                             <thead>                                
                                <tr>
                                    <th width='10%' align='left'>ORDEN: " . $folio . " </th>
                                 </tr>
                                 <tr>
                                    <th width='10%' align='left'>METODO: " . $metodo . " </th>
                                 </tr>
                                 <tr>
                                    <th width='80%' align='left'>ELABORADA: " . $orden_encabezado['fecha'] . " " . $orden_encabezado['turno'] . "</th> 
                                 </tr>
                                 <tr>";
                                 if ($tipo_orden == 2){
                                            $html_en .= "<th width='80%' align='left'>CLIENTE: ".$datos_muestras_area."</th>";
                                    }
                                    else {$html_en .= "<th width='80%' align='left'>CLIENTE: ".$orden_encabezado['unidad']. "</th>";}
                                 $html_en .= "</tr>
                                 <tr>
...
if ($tipo_orden == 2) {
    $html_en_met .= "<table border = '1' width='98%' CELLPADDING=5 CELLSPACING=0>
                            <thead>
                                <tr>
                                    <th width='80% align='center'> AA (Au, Ag y Cu):__________</th>
                                    <th width='80% align='center'> CN:__________</th>
                                    <th width='80% align='center'> pH:__________</th>   
                                    <th width='80% align='center'> CaO:__________</th>                             
                                </tr>
...
while ($fila_det = $detalle_etiquetas->fetch_assoc()) {
    ...
    $etiqueta_mg[$f] = $fila_det['muestra_geologia'];
    $f++;
}
$i = 1;
$page = 1;
...
while ($page <= $total_paginas) {
    $html_det = "<div class='row' style='margin-top: 40%; margin-left: 1%;>'";
    $columna = 1;
    while ($columna < 4 && $i <= $total_muestras) {
                        ...
                        <table border='1' cellspacing='0'>
                                            <thead>                                
                                                <tr>      
                                                    ...
                                                    if ($tipo_orden == 2) { 
                                                        $html_det .= "<th align='left' colspan='1'>MUESTRA</th>";
                                                        $html_det .= "<th align='center' colspan='2'>pH</th>";
                                                        $html_det .= "<th align='center' colspan='2'>CN</th>";
                                                        $html_det .= "<th align='center' colspan='2'>CaO</th>";
                                                    }
                                                   /* if ($tipo_orden == 6) { 
                                                        $html_det .= "<th align='left' colspan='1'>MUESTRA</th>";
                                                    }*/
        ...
        while ($total > 0) {
            ...
            $html_det .= "<tr>
                                        ...
                                        /*if ($tipo_orden == 6) { 
                                                        $html_det .= "<th colspan='1' align='left'>" . $etiqueta_mg[$i] . "</th>";
                                                    }*/
                                         if ($tipo_orden == 2) { 
                                                        $html_det .= "<th colspan='1' align='left'>" . $etiqueta_mg[$i] . "</th>";
                                                        $html_det .= "<th colspan='2'></th>";
                                                        $html_det .= "<th colspan='2'></th>";
                                                        $html_det .= "<th colspan='2'></th>";
                                                    }
                                         $html_det .= "</tr>";
...
$pdf_header .= '<cfs FONTSIZE="10"></cfs>';
//$pdf_header .= '<h3>"LABORATORIO QUIMICO: La Colorada"</h3>' ;
//$pdf_header .= '<cfs FONTSIZE="5"></cfs>';
//$pdf_header .= '<CXY X="' . ($par_x+5) . '" Y="' . ($par_y + 5) . '"></CXY>';
//$pdf_header .= '<img width="120" height="100" align="left" src="http://192.168.20.58/lcminedatalabs/images/encabezado_viaje.jpg">';
$pdf_header .= '<img width="740" height="120" align="left" src="http://172.16.52.58/lcminedatalabs/images/encabezado_prep.jpg">';
