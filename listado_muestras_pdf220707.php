...
$pdf_style .= '';
            ...
            $html_en = "<table border='0' width='98%' CELLPADDING=5 CELLSPACING=0>
                             <thead>
                                 <tr >   
                                    <th width='80%' align='center'>METODO: DRY_250, CRU_60 y PUL_85</th>
                                 </tr>                                  
                                 <tr >   
                                    <th width='80%' align='center'>ELABORADA: ".$orden_encabezado['fecha_inicio']." ".$orden_encabezado['hora']."</th> 
                                 </tr>
                                 <tr>
                                    <th width='80%' align='center'>CLIENTE:".$orden_encabezado['unidad']." </th>                                  
                                 </tr>
                                 <tr>  
                                   <th width='80%' align='center'>DESCRIPCION: Preparacion de muestras secado, quebrado y pulverizado </th>    
                                 </tr>  ";
