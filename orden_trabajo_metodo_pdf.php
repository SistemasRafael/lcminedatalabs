...
$pdf_style .= '';
            ...
            $datos_metodos = $mysqli->query("SELECT 
             ...
             $total_muestras = $total_muest['total_muestras'];
                 ...
                 $html_en = "<table border='1' width='98%' CELLPADDING=5 CELLSPACING=0>
                             <thead>
                                 <tr border>   
                                    <th width='30%'>Fecha: </th>
                                    <th width='20%'>Hora: </th> 
                                    <th width='30%' >Orden de Trabajo: </th>                                  
                                    
                                    
                                  </tr>                                  
                                  <tr>            
                                    <th width='30%'>".$orden_encabezado['fecha_inicio']."</th>
                                    <th width='20%'>".$orden_encabezado['hora']."</th>
                                    <th width='30%'>".$orden_encabezado['folio']."</th>
                                  
                                  </tr>";
                  $html_en.="</thead></table><br/>";
                  //.$orden_encabezado['unidad']..$orden_encabezado['usuario']..$orden_encabezado['fecha_inicio'].
                  
                  $html_en .= "<table border='1' width='98%' CELLPADDING=4 CELLSPACING=0>
                             <thead>
                                 <tr border> 
                  ...
                  $html_det = "<table  border='1' width='98%' CELLPADDING=5 CELLSPACING=0>
                                <thead>                                
                                     <tr>    
