...
if (isset($trn_id)){    
   ...
   //Pesaje del método 31 Au_LibreGR - si llevo la primera muestra aparte
   ...
   //Método Au_LibreGr 31 pesaje Incuarte
   if($fase_id == 18 & $etapa_id == 19 & $metodo_id == 31){
        ...
        //Método Au_LibreGr 31. pesaje PAYON
   ...
   //Método Au_LibreGR 31 peso doré
