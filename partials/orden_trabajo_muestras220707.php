 ...
 <script>
    ...
    function print_muestras(trn_id)
    {
                var trn_id_ex = trn_id;
                // alert(fecha_final_ex);
                var exportar = '<?php echo "\ listado_muestras_pdf.php?trn_id="?>'+trn_id_ex;                                  
                window.location.href = exportar;
    }
                ...
                <div class="container">
                    ...
                    <div class="col-md-4 col-lg-4">
                     ...
                     <div class="col-4 col-md-4 col-lg-4">
                        <button type="button" class="btn btn-info" name="print_muestras" id="print_muestras" onclick="print_muestras(<?echo $trn_id;?>)">  <span class="fa fa-file-pdf-o fa-2x">  Imprimir</span>    </button>
