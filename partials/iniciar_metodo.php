                            ...
                            $peso_det = $mysqli->query("SELECT
                                                      ...
                                                      FROM 
                                                        ...
                                                        LEFT JOIN ordenes_transacciones ot
                                                            ...
                                                            AND pul.trn_id_rel = ot.trn_id_rel
                                                      WHERE
                                                         pul.incuarte = 0 AND pul.trn_id = ".$trn_id." AND pul.metodo_id = ".$metodo_id." 
                                                      ORDER BY ot.folio_interno") 
                                                  or die(mysqli_error());                    
                        }
                        else{
        ...
        while ($res = $resultado->fetch_assoc()) {
                  ...
                  if ($reensaye == 0){
                        $existen_peso_dore = $mysqli->query("SELECT
                                                	         ot.trn_id_batch,
                                                             ot.trn_id_rel,
                                                             ROUND(pul.peso_dore, 2) AS peso_dore,
                                                             ot.folio_interno as muestra,
                                                             ot.control
                                                           FROM 
                                                           arg_muestras_resultados pul
                                                           ...
                                                           UNION ALL
                                                                SELECT
                                                    	         ot1.trn_id_batch,
                                                                 ot1.trn_id_rel,
                                                                 ROUND(mr.peso_dore, 2) AS peso_dore,
                                                                 ot1.folio_interno as muestra,
                                                                 ot1.control
                                                               FROM 
                                                               arg_muestras_resultados mr
                 ...
                 if ($existen_peso_dore->num_rows > 0) {                                         
                        while ($res_muestras_dore = $existen_peso_dore->fetch_assoc()) {
                            ...
                            $html.="<tr>                                  
                                         ...
                                         <td>".$muestra_folio."</td>                                         
                                         <td> <input type='number' id='peso_dore".$con."' value='".$peso_actual."' class='form-control'/> </td>
