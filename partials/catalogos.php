...
?>
 <script>
        function exportar_voladura(unidad_id)
            {
                 //var tipo = tipo;
                 var unidad_id = unidad_id;
                 //alert(tipo);
                 var exportar = '<?php echo "\ export.php?unidad_id="?>'+unidad_id;                                  
        ...
        if ($tipo == 1){
         ...
         if ($tipo == 2){
                $datos_bancos_detalle = $mysqli->query("SELECT
                                                           ...
                                                           ,b.banco
                                                           ,b.nombre
                                                           ,uba.nombre AS userbanco
                                                           ,vol.voladura_id
                                                           ,folio_inicial
                                                           ,folio_actual
                                                           ,uvol.nombre AS uservoladura
                                                        FROM
                                                           ...
                                                           LEFT JOIN arg_usuarios uba
                                                            	ON uba.u_id = b.u_id
                                                            LEFT JOIN arg_usuarios uvol
                                ...
                                <thead>
                                    <tr class='table-info' justify-content: center;>    
                                        <tr class='table-info' justify-content: center;>            
                                            ...
                                            <th colspan = '3'>VOLADURA</th>
                                        </tr>
                                    <tr class='table-info' justify-content: center;> 
                                        <th scope='col1'>Unidad de Mina</th>
                                        <th scope='col1'>Número</th>                                    
                                        <th scope='col1'>Descripción</th>
                                        <th scope='col1'>Usuario Creó</th>
