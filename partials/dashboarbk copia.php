	...
	<div id="home" class="tab-pane fade show active">
            ...
            <div class="col-sm-7">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h3>Muestras Procesadas Hoy: <?echo $hoy;?></h3>
                    </div>
                </div>
            </div>         
         </div>  
      ...
      <div class="col-sm-12">
                       ...
                       <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="fa fa-flask text-secondary border-secondary"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Muestras Recibidas Hoy</div>
                        ...
                        <div class="card">
                            ...
                            <div class="stat-widget-one">
                                <div class="stat-icon dib"><i class="fa fa-check text-success border-success"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Muestras Liberadas Hoy</div>
                                        <div class="stat-digit">1,012</div>
                                    </div>
                                </div>
                            </div>                                
                        ...
                        <div class="card">
                            ...
                            <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="fa fa-repeat text-danger border-danger"></i></div>
                                        <div class="stat-content dib">
                                            <div class="stat-text"> Reensayes Hoy</div>
                                        <div class="stat-digit">1,012</div>
                                    </div>
                            </div>
                            </div>                                
                        ...
                        <div class="card">
                            <div class="card-body">
                            <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="fa fa-refresh text-warning border-warning"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text"> Muestras en Proceso Hoy</div>
                                        <div class="stat-digit">1,012</div>
                                    </div>
                            </div>
                            </div>                                
       ...
       <div class="col-sm-9">
                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <h3>Muestras Procesadas en el Mes</h3>
                    </div>
                </div>
                </div>  
                <br/>
       ...
       <div class="col-xl-3 col-lg-3">
            ...
            <div class="card-body">
                <div class="stat-widget-one">
                    <div class="stat-icon dib"><i class="fa fa-flask text-secondary border-secondary"></i></div>
                    <div class="stat-content dib">
                    <div class="stat-text">Muestras Recibidas</div>
                        <div class="count stat-digit"><?echo $total_muestras_all;?></div>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="card-body">
                <div class="stat-widget-one">
                    <div class="stat-icon dib"><i class="fa fa-check text-success border-success"></i></div>
                    <div class="stat-content dib">
                        <div class="stat-text">Muestras Liberadas</div>
                            <div class="count stat-digit"><?echo $total_lib_mes;?></div>
                        </div>
                    </div>
                </div>                                
            </div>
            ...
            <div class="card-body">
                ...
                <div class="stat-icon dib"><i class="fa fa-repeat text-danger border-danger"></i></div>
                    <div class="stat-content dib">
                        <div class="stat-text"> Reensayes</div>
                        <div class="count stat-digit"><?echo $total_reensayes;?></div>
                    </div>
                </div>
                </div>                                
            </div>
            ...
            <div class="card-body">
                <div class="stat-widget-one">
                    <div class="stat-icon dib"><i class="fa fa-refresh text-warning border-warning"></i></div>
                        <div class="stat-content dib">
                            <div class="stat-text"> Muestras en Proceso</div>
                            <div class="stat-digit"><?echo $total_pro_mes;?></div>
                        </div>
                    </div>
                </div>                                
            </div>
