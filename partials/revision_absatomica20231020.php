...
if (isset($_GET['trn_id_abs'])){
    ...
    if ($metodo_id == 3 || $metodo_id == 6 || $metodo_id == 24){
        $existe_revision = $mysqli->query("SELECT COUNT(*) AS total_revision
                                           FROM 
                                               `temp_controles` tco
                                           WHERE tco.trn_id_batch = ".$trn_id_abs."
                                           AND tco.metodo_id = ".$metodo_id
                                   ) or die(mysqli_error());               
                ...
                <div class="col-2 col-md-2 col-lg-2">
                 ...
                 <?
                   ...
                   if ($existe_rev == 0){ 
                    ?> 
                    <div class="col-1 col-md-1 col-lg-1">
                        <button type='button' class='btn btn-danger' onclick='deshacer_rev_solidas(<? echo $trn_id_abs.", ".$metodo_id.", ".$u_id_abs.", ".$unidad_id?>)' >
