                ...
                <br/><br/><br/><br/>
                 ...
                 <? 
                  $html_det = "<table class='table table-striped' id='motivos'>
                                <thead>                                
                                     <tr class='table-info'>      
                                        <th colspan='25'>Ordenes de trabajo: ".$unidad_mina."</th>   
                                        <th></th>
                                     </tr>
                                    <tr class='table-info' justify-content: center;>            
                                        <th colspan='1'>FOLIO</th>
                                        <th colspan='1'>BATCH/ORDEN</th>
                                        <th colspan='1'>FECHA</th>
                                        <th colspan='1'>HORA</th>
                                        <th colspan='1'>TOTAL DE MUESTRAS</th>
                                        <th colspan='1'>DE LA MUESTRA</th>
                                        <th colspan='1'>A LA MUESTRA</th>                                        
                                        <th colspan='1'>ESTADO</th>
                                         <th colspan='1'>CERTIFICADO</th>
                                        <th colspan='18'>ETAPA ACTUAL POR METODO</th>";             
                                    $html_det.="</tr>
                               </thead>
                               <tbody>";
                                   ...
                                   $html_det.="<tr>";
                                      ...
                                      if ($fila['estado_id'] == 0){
                                            if ($fila['humedad'] == 1){
                                                ...
                                                $html_det.="<td colspan='5'><a type='button' class='btn btn-warning' name='print' id='print'";                                                               
                                      ...
                                      if ($fila['estado_id'] == 1 or $fila['estado_id'] == 2){
                                            if($fila['fase_id'] == 1){                                                
                                                if($fila['reensaye'] == 1 ){
                                                    ...
                                                    $html_det.="<td colspan='7'>".$fila['fase_nombre']." - ".$fila['etapa']."</td>";
                                                }                                                                                      
                                            }else{
                                                 ...
                                                 if ($fila['estado_id'] == 2){
                                                    $html_det.="<td> <a button type='button'class='btn btn-info' href='certificado_pdf.php?trn_id=".$fila['trn_id_batch']."' target='_blank'>
                                                       ...
                                                       $html_det.="<td>NO DISPONIBLE </td>"; 
                                                  }
                                                                                      
                                                  while ($fila_met = $metodos_lista->fetch_assoc()) {
                                                    
                                                      if ($fila['estado_id'] == 2){
                                                                          $variable_color = 'btn btn-warning';
                                                                        ...
                                                                        $html_det.="<td colspan='7'>".$fila_met['nombre']."-".$fila_met['etapa']."</td>";    
                                                       if ($fila['etapa_id'] == 12 or $fila['etapa_id'] == 11 ){   
                                                             if ($fila['etapa_id'] == 12){
                                                                $preel = 0;  
                                                             }
                                                             else{
                                                             ...
                                                             $html_det.="<td><a button type='button'class='btn btn-success' onclick='enviar_resultados(".$fila['trn_id_batch'].",".$fila_met['metodo_id'].",".$unidad_id.",".$preel.")'>
                                                                        <span class='fa fa-flask fa-2x'>Descargar ".$fila_met['nombre']."</span>
                                                                     </button></td>";                                                                                                                           
                                                       }
