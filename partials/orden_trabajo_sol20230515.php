...
<script>
    ...
    {
         var area_id = document.getElementById('area_seleccionada').value;
         var unidad_id = $unidad_id;                
         //alert(area_id);
    ...
    <br/><br/>
     ...
     ?>                             
                    <form method="post" action="app_sln.php?unidad_id=<?echo $unidad_id."&area_id=0";?>" name="Visitaform" id="Visitaform">  
                    <fieldset>                       
                            ...
                            <div class="col-md-11 col-lg-11">
                                  ...
                                  <div class="col-md-3 col-lg-3">  
                                        ...
                                        echo ("<select name=\"area_seleccionada\" id=\"area_seleccionada\" onchange=\"cargar_muestras($unidad_id)\" class=\"form-control\" > ");        
                                     ...
                                     <div class="col-md-1 col-lg-1">                                     
                                      ...
                                      $i = 3;
                                        while( $row = $result ->fetch_array(MYSQLI_ASSOC))                                       
                                          ...
                                          //echo 'TOTAL MUSTRAS:'.$total_muestras;
                                          ?> 
       ...
       <?
              //Click en Generar Orden
                if (isset($_POST['generar_ordenSln'])){
                    ...
                    // echo 'Total:'.$total_muest.'Hora'.$hora;
                     //$i   = 3;
                     $j = 1;
