...
$ins_id_tem   = $_POST['ins_id_tem']; 
$u_id = $_SESSION['u_id'];

if (isset($trn_id_rel)){
   mysqli_multi_query ($mysqli, "CALL arg_prc_temperaturaGuardar(".$trn_id_rel.", ".$metodo_tem.", ".$ins_id_tem.", ".$cantidad_tem.", ".$u_id.")") OR DIE (mysqli_error($mysqli));   
   ...
   $resultado = $mysqli->query("SELECT
        ...
        if ($resultado->num_rows > 0) {
            $html =  'La etapa de fundido ha finalizado.';
        }
        else{
