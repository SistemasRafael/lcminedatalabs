...
<script>
    ...
    function calculatotal()
    {
         ...
         var total_rows = parseInt(table.rows.length)-3;
         var total_mues = parseInt(0);
      
         document.getElementById('total_muestras_1').value = total_rows;         
     ...
     <?  
        if(($_SESSION['LoggedIn']) <> '')
        {
            ...
            $nombre_usuario = $user_firmado['nombre'];
                    ...
                    ?>                             
                    <form method="post" action="app_sln.php?unidad_id=<?echo $unidad_id;?>" name="Visitaform" id="Visitaform">  
                    <fieldset>                       
                            ...
                            <div class="col-md-11 col-lg-11">
                                    ...
                                    <?                           
                                        ...
                                        $result = $mysqli->query("SELECT '07:00' AS turno UNION ALL SELECT '19:00' AS turno") or die(mysqli_error());
                            ...
                            <table class="table table-hover text-black" id="tablaprueba">
                                              ...
                                              <? $datos_res = $mysqli->query("SELECT metodo_id, nombre FROM arg_metodos WHERE activo = 1 AND tipo_id = 2") or die(mysqli_error());?>
                                                 <div class="[ form-group ] ">   
                                                    <?while ($fila = $datos_res->fetch_assoc()) {?>
                                                            <input type="checkbox" name="<?echo 'fila'.$i.'_'.$fila['metodo_id']?>" id="<?echo 'fila'.$i.'_'.$fila['metodo_id']?>" autocomplete="off" />
                                                            <div class="[ btn-group ]">                                                                
                                                                <label for="<?echo 'fila'.$i.'_'.$fila['metodo_id']?>" class="[ btn btn-warning ]">
                                                                    <span class="[ glyphicon glyphicon-ok ]"></span>                            
                                                                    <span></span>
                                                                </label>                                                    
                                                                <label for="<?echo 'fila'.$i.'_'.$fila['metodo_id']?>" class="[ btn btn-default active ]">
                                                                    <?echo $fila['nombre']?>
                                                                </label>                              
                                                            </div>                                            
                                                    <?}?>                                        
                                  ...
                                  <tbody>
                                     ...
                                     <div class="col-md-1 col-lg-1">
                                      ...
                                      <?$result = $mysqli->query("SELECT trn_id, folio FROM arg_ordenes_muestrasSoluciones WHERE tipo_id = 2 AND area_id = 1") or die(mysqli_error());
                                      $i = 3;
                                        while( $row = $result ->fetch_array(MYSQLI_ASSOC))                                       
                                          {                                                
                                             $muestra = 'muestra'.$i;
                                             ...
                                             echo ("<tr> <input type='hidden' name='$muestra' id='$muestra' value='$muestra_trn' class='form-control' />                                                        
                                                         ...
                                                         <td> <input type='text' disabled='1' id='$muestra_sol' name='$muestra_sol' value='$muestra_sol' class='form-control' />                                                         
                                                         </td> 
                                                         "
                                                         );                                                                                   
                                              ?>                             
                                             
                                             <td>  <button type="button" class="btn btn-danger" onclick="eliminarFila(<? echo $i;?>)"> - FILA </button>  </td>
                                             </tr>
                                            <?                                       
                                            $i = $i+1;
                                          }?> 
                                ...
                                <tbody>
                                    <tr> 
                                      ...
                                      <td style="width:1%"></td>                               
                                      <td style="width:5%"><input type="input" name="total_muestras_1" id="total_muestras_1" disabled="1"  value="<?echo $i-3;?>" class="form-control" /></td> 
                                      <input type="hidden" name="total_muestras1" id="total_muestras1" value="<?echo $i-3;?>" class="form-control" />
                ...
                if (isset($_POST['generar_ordenSln'])){
                   ...
                   $serie_mina = $caracter_fol['serie'];
                     ...
                     $crear = 1;
                                ...
                                //echo 'totalmuestr:'.$total_muest.'</br>'.'fin';
                                //echo 'muestraPost:'.$muestra_sln.'</br>'.'fin';                       
                                        ...
                                        while ($metodos = $metodos_validar->fetch_assoc()) {
                                                ...
                                                if ($metodo_sel == 'on'){
                                                            ...
                                                            //echo $query;
                                                             ...
                                                             while($j <= $fin){ 
                                                                ...
                                                                echo 'entro'.$i.'</br>';
                                                                     ...
                                                                     $query = "INSERT INTO arg_ordenes_soluciones (trn_id_batch, trn_id_rel, metodo_id, posicion, folio_interno, resultado, u_id) ".
                                                                                                        "VALUES  ($tr_id_det, $muestra_sln, $metodo_id, $pos, '$folio_interno_det', 0, $u_id)";                                                    
                                                                     $mysqli->query($query);
                                                                     echo $query.'</br>';
                                                                     $i++;  
                                                                     $j++;
                                                            ...
                                                            elseif($metodo_id == 19){
                                                                ...
                                                                $query = "INSERT INTO arg_ordenes_bit
                                                                acora_detalle (trn_id_rel, metodo_id, fase_id, etapa_id, u_id, fecha_fin, u_id_fin)
