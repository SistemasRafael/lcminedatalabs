...
$pdf_style .= '';
            ...
            $datos_orden = $mysqli->query("SELECT
             ...
             $pdf_html .= '<div style="page-break-before: always;"></div>';
...
$ifactor = 220 / 1050;
$iwidth = 500;
//$pdf_content .= "<CXY X='0' Y='80'></CXY>";
//$pdf_content .= '<img width="' . (floor($iwidth * $img_factor)) . '" height="' . (floor(($iwidth * $ifactor) * $img_factor)) . '" src="http://192.168.10.112/dgominedatalabs/images/encabezado_prep.jpg" margin-top="20">';

$pdf_content .= '<img width="750px" src="http://192.168.10.112/dgominedatalabs/images/encabezado_prep.jpg"</img>';
//$pdf_content .= '<img src="http://192.168.10.112/dgominedatalabs/images/Minedata_labhs.jpg"</img>';
